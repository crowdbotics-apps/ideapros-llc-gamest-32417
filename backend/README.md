...
## Project Structure
    ...
    ├── ideapros_llc_gamest_32417  # Django project configurations
...
1. Clone this repo and `cd ideapros_llc_gamest_32417`
...
2. Clone this repo and `cd ideapros_llc_gamest_32417`
